...
python clean_dict.py dict/corpus_dict.txt dict/corpus_dict_clean.txt zgh

echo "Generating training data..."
trdg -c 20000 -w 1 -t 2 -f 50 -k 2 -rk -bl 1 -rbl -tc '#000000,#888888' -na 2 -fd fonts/ -dt dict/corpus_dict_clean.txt --output_dir gen_train
echo "Generating validation data..."
trdg -c 4000 -w 1 -t 2 -f 50 -k 2 -rk -bl 1 -rbl -tc '#000000,#888888' -na 2 -fd fonts/ -dt dict/corpus_dict_clean.txt --output_dir gen_val
